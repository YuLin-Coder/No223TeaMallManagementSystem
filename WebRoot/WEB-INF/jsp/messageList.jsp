			...
			<table>
				...
				<tr align="center">
					...
					<div class="pagination">
								<span>第${messages.page}/${messages.totlePage}页</span>
								<c:if test="${messages.page!=1}">
									<a href="${ pageContext.request.contextPath }/messages.action?page=1" class="firstPage">&nbsp;</a>
									<a
										href="${ pageContext.request.contextPath }/messages.action?page=${messages.page-1}"
										class="previousPage">&nbsp;</a>
								</c:if>
								<c:forEach var="i" begin="1" end="${messages.totlePage}">
									<c:choose>
										<c:when test="${messages.page!=i}">
											<a
								...
								<c:if test="${messages.page!=messages.totlePage}">
									<a class="nextPage"
										href="${ pageContext.request.contextPath }/messages.action?page=${messages.page+1}">&nbsp;</a>
									<a class="lastPage"
										href="${ pageContext.request.contextPath }/messages.action?page=${messages.totlePage}">&nbsp;</a>
								</c:if>
							</div>
					</td>
				</tr>
