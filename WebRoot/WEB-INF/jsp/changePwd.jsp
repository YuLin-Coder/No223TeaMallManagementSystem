...
<body>
	...
	<div class="container cart">
		<form
			action="${ pageContext.request.contextPath }/changeedpwd.action"
			  >
			原密码：<input type="text" name="opassword" /> 新密码：<input type="text"
				name="password" /> 重复密码：<input type="text" name="repassword" /> <input
				type="submit" value="发表留言"></input>
		</form>
