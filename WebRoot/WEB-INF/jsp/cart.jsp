...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
	 	 ...
	 	 function checkClear() {
			return window.confirm("确定要清空购买茶叶车吗?");
		}
    </script>
			...
			<div class="span24">
				...
				<div class="total">
					<em id="promotion"></em> <em> 登录后确认是否享有优惠 </em> 赠送积分: <em
						id="effectivePoint">${cart.totale}</em> 茶叶金额: <strong
						id="effectivePrice">${cart.totale}</strong>
				</div>
				<div class="bottom">
					<a href="${ pageContext.request.contextPath }/clearCart.action"
						id="clear" class="clear" onclick="return checkClear();">清空购买茶叶车</a>
					<a
		...
		<c:otherwise>
			<div class="span24">
				<div class="step step1">
					<span><h2>亲!您还没有购买茶叶!请先去购买茶叶!</h2></span>
				</div>
			</div>
		</c:otherwise>
	</c:choose>
