...
<body>
	...
	<div class="container cart">
			<table>
				...
				<tr>
				<td colspan="7">
					<form action="${ pageContext.request.contextPath }/admin/editGonggao.action" method="post">
					  标题：<input type="text" name="title"value="${ gonggao.title }"/>
					    <input style="display:none" type="text" name="id" value="${ gonggao.id }"/>
				    	<textarea rows="10" cols="10" id="messageinfo" name="content"> ${ gonggao.content }  </textarea>  
				    	<ck:replace replace="content" basePath="ckeditor"></ck:replace>  
				    	<input type="submit" value="编辑公告"></input>
				    </form>
				</td>
				</tr>
		</table>
